...
with col1:
  with st.container():
    ...
    st.image(image1)
    st.link_button("Review your communication skills", "https://blueshackst.streamlit.app")
...
with col2:
  with st.container():
    ...
    st.image(image2)
    st.link_button("Get clarification on class content", "https://blueshacks2.streamlit.app/")
